                    ...
                    <div class="row mb-3">
                        <div class="header-card card p-4">
                            <div class="d-flex justify-content-between align-items-center mt-2">
                                <div>
                                    <h2 class="color-purple">Billing </h2>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Generate a Billing</h3>
            </div>
            <div class="box-body">
              <!-- Date -->
              <!-- /.form group -->
              ...
              <!-- Date and time range -->
       <!--        <table border="0" style="width:40%; "><tr>
              <Td> <button type="button" class="btn btn-success btn_pdf" id="btn_pdf_server" > <span class="fa fa-archive"></span> View in PDF </button> </Td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>

                <Td> <button type="button" class="btn btn-info btn_reports" id="upload_to_server" > <span class="fa fa-download"></span> Download Files</button> </Td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td> -->
                          <?php
...
<div class="container">
  <div class="row">
    <div class="col-sm">
        Clinic<select  class="form-control noSpace"  id="clinics" >
                <?php if($account_types=="admin"){ ?>
    ...
    <div class="col-sm">
        Date  Created
        <input type="text"  class="form-control search-box"  value=""  id="date_created"   name="datefilter" placeholder="Enter Date Created" />
    </div>
    <div class="col-sm">
        <br>
       <button type="button" class=" form-control btn btn-info  " id="search_clinic" > <span class="fa fa-search"></span> Generate</button></Td>
    </div>
  </div>
</div>
 ...
 $('input[name="datefilter"]').on('apply.daterangepicker', function(ev, picker) {
  ...
  $(document).on("click","#search_clinic",function(){ 
    ...
    if(clinics == "All"){
     ...
     window.open("billing.php?uid=" + clinics + "&date=" + dcr);      
...
window.open("pdf/report_pdf.php?data="+encodeURI(temp), '_blank');
    ...
    $(document).on('click','.edit_btn', function (e) {
            var id=$(this).attr("id");
       window.location.replace("../edit/edit_report?uid="+id);
...
//alert("<?php //echo $username_login; ?>"+"<?php //echo $lto_accreditation_no; ?>====="+id_extend_btn);
           bios();
