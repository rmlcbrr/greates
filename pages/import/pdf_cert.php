...
// Include the qrlib file 
      ...
      $text = "https://systechph-medical.com/pages/import/search.php?internal_reference_no=".base64_encode($user['internal_reference_no']); 
      ...
      $path = 'images/'; 
      $file = $path.$user['internal_reference_no'].".png"; 
        
      // $ecc stores error correction capability('L') 
      $ecc = 'L'; 
      $pixel_Size = 10; 
      $frame_Size = 10; 
    if (file_exists("images/".$user['internal_reference_no'].".png")) {
...
// echo "<center><img src='".$file."' style='width:120px;'></center>"; 
  ...
  $pdf->Image('../../dist/img/department.png', '', '', 20, 20, '', '', 'T', false, 100, '', false, false, 0, false, false, false);
    ...
    $pdf->SetXY(180, 15);
  $pdf->Image('C:/xampp/htdocs/dist/images/lto.png', '', '', 30, 20, '', '', 'T', false, 100, '', false, false, 0, false, false, false);



 $pdf->SetXY(180, 50);
  $pdf->Image('../../control/upload/$imgs', '', '', 20, 20, '', '', 'T', false, 100, '', false, false, 0, false, false, false);


  //qrcode
 $pdf->SetXY(183, 207);
  $pdf->Image('images/$file' , '', '', 20, 20, '', '', 'T', false, 100, '', false, false, 0, false, false, false);
