 ...
 Webcam.set({
    ...
    function take_snapshot() {
        ...
        Webcam.snap( function(data_uri) {
            ...
            document.getElementById('results').innerHTML = '<img id="blah" class="img-thumbnail profile-pic" style="width:260px; height:90px;" src="'+data_uri+'"/>';
              ...
              //  console.log((response));
               $("#proceeds_save").attr("disabled", "disabled");
                         ...
                         fd.append('img_data',img_data);
                          ...
                          fd.append('internal_reference_no','N/A');
                          ...
                          setTimeout(function() {
                                //  $this.html("Save");   
                                   $("#proceeds_save").removeAttr("disabled");
                                      //  oTable.ajax.reload();
                                      window.location.replace("non-bio");
